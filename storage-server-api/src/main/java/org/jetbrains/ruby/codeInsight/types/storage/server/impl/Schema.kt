...
object GemInfoTable : IntIdTable() {
    val name = varchar("name", GemInfoConstraint.LENGTH_OF_GEMNAME).index()
    val version = varchar("version", GemInfoConstraint.LENGTH_OF_GEMVERSION)
}
...
object ClassInfoTable : IntIdTable() {
    ...
    val fqn = varchar("fqn", ClassInfoConstraint.LENGTH_OF_FQN)
}
...
object MethodInfoTable : IntIdTable() {
    ...
    val name = varchar("name", MethodInfoContraint.LENGTH_OF_NAME)
    val visibility = enumeration("visibility", RVisibility::class.java)
    val locationFile = varchar("location_file", MethodInfoContraint.LENGTH_OF_PATH).nullable()
